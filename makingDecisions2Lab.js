...
let someNum = myFavoriteNumbers.splice(4, 1, 0)
console.log(someNum)
////////// PROBLEM 7 //////////
...
if (myFavoriteNumbers.length < 7) {
  ...
  someNum = myFavoriteNumbers.splice(4, 1, 0)
}
...
for (i = 0; i<listOfNumbers.length; i++) {
  if (listOfNumbers[i] % 3 === 0) {
    console.log("number is divisible by 3", listOfNumbers[i])
  }
}
